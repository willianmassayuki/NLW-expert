  ...
  return (
    <button className="rounded-md bg-slate-800 p-5 space-y-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 text-left focus-visible:ring-2 focus-visible:ring-lime-400 outline-none">
      ...
      <p className="text-sm leading-4 text-slate-400">
        ...
        blanditiis impedit tempora dicta aut officia magni similique,
        praesentium sapiente? Consequatur qui, repellendus ipsa voluptas dolore
        officiis praesentium aliquid magni beatae.
      </p>
